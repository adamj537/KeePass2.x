namespace KeePass.Forms
{
	partial class EcasTriggerForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_lvEvents = new System.Windows.Forms.ListView();
			...
			this.m_lvConditions = new System.Windows.Forms.ListView();
