...
namespace KeePass.Resources
{
	...
	public static partial class KPRes
	{
		...
		public static void SetTranslatedStrings(Dictionary<string, string> dictNew)
		{
			...
			m_strShowObject = TryGetEx(dictNew, "ShowObject", m_strShowObject);
			...
			m_strTimeOtp = TryGetEx(dictNew, "TimeOtp", m_strTimeOtp);
		...
		private static string m_strShowObject =
			@"Show {PARAM}";
		/// <summary>
		/// Look up a localized string similar to
		/// 'Show {PARAM}'.
		...
		private static string m_strTimeOtp =
			@"Time-Based OTP";
		/// <summary>
		/// Look up a localized string similar to
		/// 'Time-Based OTP'.
